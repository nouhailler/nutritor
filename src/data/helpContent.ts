...
export const HELP: Record<string, HelpContent> = {
  ...
  home: {
    ...
    blocks: [
      ...
      { type: 'item', icon: 'zap', label: 'Mini-métriques', text: 'Chaque créneau horaire affiche l\'impact estimé sur l\'index glycémique, la charge digestive et le niveau d\'énergie, calculé à partir des aliments ingérés.' },
